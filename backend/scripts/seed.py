...
ACCOUNTS = [
    # Assets
    {"code": "1000", "name": "Cash & Bank",             "type": "asset",     "subtype": "bank",         "normal_balance": "debit"},
    {"code": "1010", "name": "Business Cheque Account", "type": "asset",     "subtype": "bank",         "normal_balance": "debit",  "parent": "1000"},
    {"code": "1020", "name": "Savings Account",         "type": "asset",     "subtype": "bank",         "normal_balance": "debit",  "parent": "1000"},
    ...
    {"code": "1910", "name": "Computer Equipment",      "type": "asset",     "subtype": "fixed_asset",  "normal_balance": "debit",  "parent": "1900"},
    {"code": "1920", "name": "Accumulated Depreciation","type": "asset",     "subtype": "contra_asset", "normal_balance": "credit", "parent": "1900"},
    # Liabilities
    {"code": "2000", "name": "Accounts Payable",        "type": "liability", "subtype": "payable",      "normal_balance": "credit"},
    {"code": "2100", "name": "GST Collected",           "type": "liability", "subtype": "tax",          "normal_balance": "credit"},
    {"code": "2110", "name": "GST Paid (ITC)",          "type": "asset",     "subtype": "tax",          "normal_balance": "debit"},
    {"code": "2200", "name": "PAYG Withholding",        "type": "liability", "subtype": "tax",          "normal_balance": "credit"},
    {"code": "2500", "name": "Loans Payable",           "type": "liability", "subtype": "loan",         "normal_balance": "credit"},
    {"code": "2900", "name": "Accrued Liabilities",     "type": "liability", "subtype": "accrued",      "normal_balance": "credit"},
    # Equity
    ...
    {"code": "3200", "name": "Current Year Earnings",   "type": "equity",    "subtype": "earnings",     "normal_balance": "credit"},
    # Revenue
    {"code": "4000", "name": "Revenue",                 "type": "revenue",   "subtype": "sales",        "normal_balance": "credit"},
    {"code": "4100", "name": "Consulting Revenue",      "type": "revenue",   "subtype": "sales",        "normal_balance": "credit", "parent": "4000"},
    {"code": "4200", "name": "Product Sales",           "type": "revenue",   "subtype": "sales",        "normal_balance": "credit", "parent": "4000"},
    {"code": "4300", "name": "Service Revenue",         "type": "revenue",   "subtype": "sales",        "normal_balance": "credit", "parent": "4000"},
    ...
    {"code": "6100", "name": "Salaries & Wages",        "type": "expense",   "subtype": "payroll",      "normal_balance": "debit",  "parent": "6000"},
    {"code": "6200", "name": "Rent & Occupancy",        "type": "expense",   "subtype": "facilities",   "normal_balance": "debit",  "parent": "6000"},
    {"code": "6300", "name": "Software & Subscriptions","type": "expense",   "subtype": "software",     "normal_balance": "debit",  "parent": "6000"},
    {"code": "6400", "name": "Marketing & Advertising", "type": "expense",   "subtype": "marketing",    "normal_balance": "debit",  "parent": "6000"},
    {"code": "6500", "name": "Professional Services",   "type": "expense",   "subtype": "professional", "normal_balance": "debit",  "parent": "6000"},
    {"code": "6600", "name": "Travel & Entertainment",  "type": "expense",   "subtype": "travel",       "normal_balance": "debit",  "parent": "6000"},
    {"code": "6700", "name": "Depreciation",            "type": "expense",   "subtype": "depreciation", "normal_balance": "debit",  "parent": "6000"},
    {"code": "6800", "name": "Bank Charges",            "type": "expense",   "subtype": "bank",         "normal_balance": "debit",  "parent": "6000"},
    {"code": "6900", "name": "Other Expenses",          "type": "expense",   "subtype": "other",        "normal_balance": "debit",  "parent": "6000"},
]
...
async def seed_contacts(db: AsyncSession) -> dict[str, str]:
    data = [
        ...
        ("LEGAL", "Smith & Partners Law", "supplier", "accounts@smithlaw.example","+61 2 9000 0300"),
    ]
    ids: dict[str, str] = {}
    for code, name, ctype, email, phone in data:
        c = Contact(
            ...
            email=email, phone=phone, currency="AUD",
            created_by=ACTOR_ID, updated_by=ACTOR_ID,
        )
        db.add(c)
        ids[code] = c.id
...
async def seed_invoices(db: AsyncSession, accs: dict[str, str], contacts: dict[str, str]) -> None:
    data = [
        ("INV-00001", "ACME",  "2026-02-01", "2026-03-01", "2026-02", "4100", "250000", "Consulting — Feb 2026",  "22000.00"),
        ("INV-00002", "GLOBEX","2026-02-14", "2026-03-14", "2026-02", "4100", "250000", "Consulting — Feb 2026",  "38500.00"),
        ("INV-00003", "INIT",  "2026-03-01", "2026-03-31", "2026-03", "4300", "250000", "Service delivery Q1",    "15000.00"),
        ("INV-00004", "WAYNE", "2026-03-15", "2026-04-15", "2026-03", "4200", "250000", "Product licence",        "9900.00"),
        ("INV-00005", "ACME",  "2026-04-01", "2026-05-01", "2026-04", "4300", "250000", "Service retainer Apr",   "12000.00"),
        ("INV-00006", "GLOBEX","2026-04-10", "2026-05-10", "2026-04", "4100", "250000", "Consulting — Apr 2026",  "50000.00"),
    ]
    ...
    for (number, contact_code, issue, due, period, rev_code, _fx, desc, amount), inv_status in zip(data, statuses, strict=False):
        ...
        inv = Invoice(
            ...
            total=amt, amount_due=amt if inv_status != "paid" else Decimal("0"),
...
async def seed_bills(db: AsyncSession, accs: dict[str, str], contacts: dict[str, str]) -> None:
    data = [
        ("BILL-00001", "AWS",   "2026-02-28", "2026-03-28", "2026-02", "6300", "AWS hosting Feb",        "1350.00",  "approved"),
        ("BILL-00002", "MSFT",  "2026-02-28", "2026-03-28", "2026-02", "6300", "Azure compute Feb",      "890.00",   "approved"),
        ("BILL-00003", "RENT",  "2026-03-01", "2026-03-07", "2026-03", "6200", "Office rent Mar",        "4500.00",  "approved"),
        ("BILL-00004", "JIRA",  "2026-03-31", "2026-04-14", "2026-03", "6300", "Atlassian suite Mar",    "420.00",   "approved"),
        ("BILL-00005", "SLACK", "2026-03-31", "2026-04-14", "2026-03", "6300", "Slack Pro Mar",          "180.00",   "awaiting_approval"),
        ("BILL-00006", "RENT",  "2026-04-01", "2026-04-07", "2026-04", "6200", "Office rent Apr",        "4500.00",  "draft"),
        ("BILL-00007", "LEGAL", "2026-04-05", "2026-05-05", "2026-04", "6500", "Legal retainer Apr",     "2000.00",  "draft"),
        ("BILL-00008", "AWS",   "2026-04-30", "2026-05-30", "2026-04", "6300", "AWS hosting Apr",        "1420.00",  "draft"),
    ]
    ...
    for number, contact_code, issue, due, period, exp_code, desc, amount, bill_status in data:
        ...
        bill = Bill(
            ...
            currency="AUD", fx_rate=Decimal("1"),
            subtotal=amt, tax_total=Decimal("0"),
            total=amt, amount_due=amt if bill_status != "paid" else Decimal("0"),
            functional_total=amt,
            created_by=ACTOR_ID, updated_by=ACTOR_ID,
        )
        db.add(bill)
...
async def main() -> None:
    ...
    async with AsyncSessionLocal() as db:
        ...
        if not tenant:
            db.add(Tenant(
                id=TENANT_ID, name="Aegis Demo Co", legal_name="Aegis Demo Pty Ltd",
                country="AU", functional_currency="AUD",
                fiscal_year_start_month=7, timezone="Australia/Sydney",
    ...
    print("   Set this in your browser: localStorage.setItem('aegis_tenant_id', '" + TENANT_ID + "')\n")
